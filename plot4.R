...
globalreactivepower <- as.numeric(desireddates$Global_reactive_power)
voltage <- as.numeric(desireddates$Voltage)

png("Plot2.png",width=480 ,height=480)
par(mfrow = c(2, 2)) 
plot(desiredplot1, main="Global Active Power",xlab=" ",ylab="Global Active Power", cex=0.2)

plot(formatdt, voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(formatdt, globalreactivepower, type="l", xlab="datetime", ylab="Global_reactive_power")
